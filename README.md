...
> [Vue Upload Multiple Images example](https://bezkoder.com/vue-upload-multiple-image/)

> [(Using Vuetify) Multiple Images Upload example with Progress Bar](https://bezkoder.com/vuetify-multiple-image-upload/)
